...
var file_proto_borrow_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x06, 0x62, 0x6f, 0x72, 0x72, 0x6f, 0x77, 0x22, 0x1b, 0x0a, 0x07,
	...
	0x42, 0x6f, 0x72, 0x72, 0x6f, 0x77, 0x12, 0x2b, 0x0a, 0x04, 0x43, 0x61, 0x6c, 0x6c, 0x12, 0x0f,
	0x2e, 0x62, 0x6f, 0x72, 0x72, 0x6f, 0x77, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a,
	...
	0x62, 0x6f, 0x72, 0x72, 0x6f, 0x77, 0x2e, 0x53, 0x74, 0x72, 0x65, 0x61, 0x6d, 0x69, 0x6e, 0x67,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x19, 0x2e, 0x62, 0x6f, 0x72, 0x72, 0x6f, 0x77,
	...
	0x6e, 0x67, 0x12, 0x0c, 0x2e, 0x62, 0x6f, 0x72, 0x72, 0x6f, 0x77, 0x2e, 0x50, 0x69, 0x6e, 0x67,
	0x1a, 0x0c, 0x2e, 0x62, 0x6f, 0x72, 0x72, 0x6f, 0x77, 0x2e, 0x50, 0x6f, 0x6e, 0x67, 0x22, 0x00,
	0x28, 0x01, 0x30, 0x01, 0x42, 0x0e, 0x5a, 0x0c, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x3b, 0x62, 0x6f,
	0x72, 0x72, 0x6f, 0x77, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_proto_borrow_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_borrow_proto_goTypes = []interface{}{
	(*Message)(nil),           // 0: borrow.Message
	(*Request)(nil),           // 1: borrow.Request
	(*Response)(nil),          // 2: borrow.Response
	(*StreamingRequest)(nil),  // 3: borrow.StreamingRequest
	(*StreamingResponse)(nil), // 4: borrow.StreamingResponse
	(*Ping)(nil),              // 5: borrow.Ping
	(*Pong)(nil),              // 6: borrow.Pong
}
var file_proto_borrow_proto_depIdxs = []int32{
	1, // 0: borrow.Borrow.Call:input_type -> borrow.Request
	3, // 1: borrow.Borrow.Stream:input_type -> borrow.StreamingRequest
	5, // 2: borrow.Borrow.PingPong:input_type -> borrow.Ping
	2, // 3: borrow.Borrow.Call:output_type -> borrow.Response
	4, // 4: borrow.Borrow.Stream:output_type -> borrow.StreamingResponse
	6, // 5: borrow.Borrow.PingPong:output_type -> borrow.Pong
